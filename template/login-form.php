...
<form  method="POST">
    <ul class="list-group text-center">
        ...
        <li>
            <div class="row d-flex justify-content-center bg-primary col-3 mx-auto mt-4 rounded">
            <i class="fab fa-facebook fa-2x col-3 p-1"></i> <a class="col-8 text-light p-2"  href="">Connettiti con Facebook</a>
            </div>
        </li>
       
        <li>
            <div class="row d-flex justify-content-center bg-primary col-3 mx-auto mt-4 rounded">
           <img src="<?php echo UPLOAD_DIR?>./google.png" alt=""><a class="col-8 text-light p-2"  href="">Connettiti con Google</a>
            </div>
        </li>
