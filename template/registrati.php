    ...
    <div class="container-fluid">
        <div class="row m-2">
            <div class="profilo col-sm-0 text-center">
                ...
                <form action="gestisci_registrazione.php?action=1" method="post">
                    <button class="rounded"  name="cliente">Sono un cliente</button>
        ...
        <div class="row m-2">
            <div class="profilo col-sm-0 text-center">
                ...
                <form action="gestisci_registrazione.php?action=1" method="post">
                    <button class="rounded" name="agricoltore">Sono un agricoltore</button>
